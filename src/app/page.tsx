  ...
  const features = [
    {
      ...
      description:
        "Choose from various hostel blocks strategically located across campus",
      bgColor: "bg-blue-100",
    ...
    },
    {
      ...
      description:
        "Single, 2-sharing, and 3-sharing options to match your lifestyle",
        ...
        <section className="relative overflow-hidden bg-linear-to-r from-blue-600 via-indigo-600 to-purple-600 text-white">
          ...
          <div className="relative max-w-6xl mx-auto px-6 py-20 text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
              Welcome to{" "}
              <span className="text-yellow-300">Smart Hostel Finder</span>
            </h1>
            <p className="text-xl md:text-2xl max-w-3xl mx-auto mb-8 text-blue-100">
              Discover your ideal living space with our intelligent room
              allocation system. Find comfort, convenience, and community.
            </p>
        ...
        <div className="max-w-6xl mx-auto px-6 py-12 space-y-16">
          ...
          <section id="rooms">
            <div className="text-center mb-10">
              <h2 className="text-4xl font-bold mb-3 bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                Available Rooms
              </h2>
              <p className="text-gray-600 text-lg">
                Browse through our carefully curated selection of rooms
              </p>
            </div>
          ...
          <section
            id="about"
            className="bg-linear-to-r from-white to-blue-50 rounded-2xl p-10 shadow-lg"
          >
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-gray-700 text-lg leading-relaxed mb-4">
                  Smart Hostel Room Allocation revolutionizes hostel management
                  with cutting-edge technology. Our platform provides a seamless
                  public dashboard showcasing room availability, types, and
                  amenities in real-time.
                </p>
                <p className="text-gray-700 text-lg leading-relaxed">
                  Built with advanced algorithms, we're shaping the future of
                  automated student accommodation allocation, making hostel life
                  better for everyone.
                </p>
              </div>
          ...
          <section
            id="contact"
            className="bg-linear-to-br from-indigo-600 to-purple-700 rounded-2xl p-10 shadow-xl text-white text-center"
          >
