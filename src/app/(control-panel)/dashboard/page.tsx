"use client";
import CPFooter from "@/components/ControlPanelFooter";
import CPHeader from "@/components/ControlPanelHeader";
import {
  LayoutDashboard,
  Building2,
  Users,
...
function QuickAction({
  ...
  return (
    <button className="bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition transform hover:-translate-y-1 text-left w-full">
      <div
        className={`w-12 h-12 ${color} bg-opacity-10 rounded-lg flex items-center justify-center mb-4`}
      >
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600">
                          {activity.room || "Maintenance Request"}
                        </p>
